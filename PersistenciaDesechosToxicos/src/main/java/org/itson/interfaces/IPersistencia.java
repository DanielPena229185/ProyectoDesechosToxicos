...
/**
 * Descripción de la interface:a interfaz que define metodos para insertar y
...
public interface IPersistencia {
     ...
     * @return el objeto Productor correspondiente a los datos de inicio de
     * sesión si son válidos
     * @throws PersistenciaException si los datos de inicio de sesión son
     * incorrectos o hay algún problema al realizar la autenticacion
     */
     ...
     * busqueda.
     * @return una lista de objetos Solicitud que cumplen con los criterios
     * especificados.
     * @throws PersistenciaException si hay algún problema al realizar la
     * consulta.
     */
     ...
     *
     * @param empresaTransportista la empresa transportista a la que se le
     * asignaron los traslados
     * @return una lista de objetos Traslado asignados a la empresa
    ...
    /**
     * Devuelve una lista de Vehiculos pertenecientes a una EmpresaTransportista
     * especifica.
     *
     * @param empresaTransportista la EmpresaTransportista de la cual se quieren
     * obtener los Vehiculos.
     * @return una lista de Vehiculos pertenecientes a la EmpresaTransportista
     * especificada.
