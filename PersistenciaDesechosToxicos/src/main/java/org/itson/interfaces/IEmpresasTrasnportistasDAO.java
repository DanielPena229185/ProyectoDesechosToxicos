...
/**
 * Descripción de la interface: Define una interfaz que describe las operaciones
 * que se pueden realizar en una fuente de datos persistente para manejar
 * empresas transportistas, incluye metodos para recuperar todas las empresas,
 * insertar nuevas empresas y autenticar empresas mediante correo electrónico y
 * contrasena
 *
