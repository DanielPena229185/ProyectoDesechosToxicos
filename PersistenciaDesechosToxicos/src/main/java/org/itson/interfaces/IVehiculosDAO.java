...
/**
 * Descriocion de la interfaz:Esta interfaz define dos métodos para interactuar
 * con una base de datos de vehiculos
 *
...
public interface IVehiculosDAO {
     ...
     * @return el Vehiculo insertado con el identificador generado por la base
     * de datos.
