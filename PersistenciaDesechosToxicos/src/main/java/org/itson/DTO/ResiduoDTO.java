 ...
 * Contiene informacion básica de un residuo como su identificador de empresa
 * productora, nombre de la empresa productora, clave del residuo, nombre del
 * residuo y lista de quimicos asociados al residuo
 *
...
public class ResiduoDTO {
     ...
     *
     * @param id_EmpresaProductora el identificador de la empresa productora del
     * residuo
     */
     ...
     *
     * @param nombreEmpresaProductora el nombre de la empresa productora del
     * residuo
     */
