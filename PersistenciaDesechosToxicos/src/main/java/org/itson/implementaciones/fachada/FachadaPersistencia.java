 ...
 * de los datos que son relacionados con los quimicos, residuos, productores, solicitudes, empresas transportistas
 * y los traslados. Proporciona los metodos de insertar y consultar objetos de cada uno de los tipos que maneja,
 * los metodos que realizan la insercion y consulta de cada tipo de objetos de DAO necesarios para realizar las 
 * operaciones de persistencia que se necesiten y en si en caso que ocurra una excepcion el sistema lanzara una excepcion
 * del tipo PersistenciaExcepcion indicando dicho error
 *
...
public class FachadaPersistencia implements IPersistencia {
    ...
    /**
     * Inserta un objeto quimico en algun tipo de almacenamiento utilizando un objeto QuimicoDAO 
     * @param o el objeto quimico a insertar
     * @return el objeto quimico insertado, incluyendo cualquier identificador generado por el sistema de persistencia
    ...
    /**
     * Recupera todos los objetos quimico almacenados en algun tipo de almacenamiento utilizando un objeto QuimicoDAO
    ...
    /**
     * Inserta un objeto residuo en algún tipo de almacenamiento utilizando un objeto ResiduoDAO
     * @param o el objeto residuo a insertar
     * @return el objeto residuo insertado, incluyendo cualquier identificador generado por el sistema de persistencia
     * @throws PersistenciaException si ocurre un error durante la ejecucion
     */
    @Override
    ...
    /**
     * Recupera una lista de objetos residuo que cumplen con ciertos criterios utilizando un objeto ResiduoDAO
     * @param residuo residuo un objeto ResiduoDTO que especifica los criterios de búsqueda
     * @return una lista de objetos residuo que cumplen con los criterios especificados
     * @throws PersistenciaException si ocurre un error durante la ejecucion
     */
    @Override
    ...
    /**
     * Inserta un objeto Productor en algun tipo de almacenamiento utilizando un objeto ProductorDAO
     * @param o el objeto productor a insertar
     * @return el objeto productor que esta insertado incluyendo cualquier identificador generado por el sistema de persistencia
     * @throws PersistenciaException si ocurre un error durante la ejecucion 
     */
    @Override
    ...
    /**
     * Consulta el objeto productor con el correo y contrasena especificados utilizando un objeto ProductorDAO
    ...
    /**
     * Consulta todas las solicitudes que no han sido atendidas usando un objeto SolicitudDAO
    ...
    /**
     * Consulta las solicitudes que cumplen con los criterios especificados en un objeto SolicitudDTO utilizando un objeto SolicitudDAO
     * @param  filtro el objeto SolicitudDTO que contiene los criterios de busqueda
     * @return una lista de solicitud que cumplen con los criterios especificados
     * @throws PersistenciaException si ocurre un error durante la ejecucion
     */
    @Override
    ...
    /**
     * Consulta una lista de objetos traslado asignados a una EmpresaTransportista especificada
     * @param empresaTransportista la EmpresaTransportista para la cual se desea consultar los Traslados asignados
     * @return la lista de objetos traslado asignados a la EmpresaTransportista especificada
     * @throws PersistenciaException si ocurre un error durante la ejecucion
     */
    @Override
