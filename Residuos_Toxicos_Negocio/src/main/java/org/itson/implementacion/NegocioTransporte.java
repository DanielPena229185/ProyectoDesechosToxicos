...
public class NegocioTransporte implements INegocioTransporte {
     ...
     * @throws ValidacionException Si el transporte es nulo o no cumple con los
    ...
    /**
     * Realiza la partición de la empresa transportista, eliminando los
     * vehículos y transportes asociados.
     *
