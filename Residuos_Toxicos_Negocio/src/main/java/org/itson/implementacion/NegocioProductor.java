...
public class NegocioProductor implements INegocioProductor {
     ...
     *
     * @param productorDTO El objeto ProductorDTO que contiene los datos del
     * productor para el inicio de sesión.
     ...
     * @return true si el correo electrónico no cumple con el formato válido,
     * false si cumple con el formato válido
     */
